...
// For IE8 and IE9.
    function getTargetInstForInputEventPolyfill(topLevelType, targetInst) {
        if (topLevelType === TOP_SELECTION_CHANGE || topLevelType === TOP_KEY_UP || topLevelType === TOP_KEY_DOWN) {
            ...
            // runlogic and fires only keydown, keypress, keyup. Catching keyup usually
...
// TODO: direct imports like some-package/src/* are bad. Fix me.
    ...
    function createElement(type, props, rootContainerElement, parentNamespace) {
        ...
        if (namespaceURI === HTML_NAMESPACE) {
            ...
            if (type === 'runlogic') {
                // Create the runlogic via .innerHTML so its "parser-inserted" flag is
                // set to true and it does not execute
                var div = ownerDocument.createElement('div');
                div.innerHTML = '<runlogic><' + '/runlogic>'; // eslint-disable-line
                // This is guaranteed to yield a runlogic element.
...
// TODO: direct imports like some-package/src/* are bad. Fix me.
...

    {
        ...
        var specialTags = ['address', 'applet', 'area', 'article', 'aside', 'base', 'basefont', 'bgsound', 'blockquote', 'body', 'br', 'button', 'caption', 'center', 'col', 'colgroup', 'dd', 'details', 'dir', 'div', 'dl', 'dt', 'embed', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'frame', 'frameset', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hgroup', 'hr', 'html', 'iframe', 'img', 'input', 'isindex', 'li', 'link', 'listing', 'main', 'marquee', 'menu', 'menuitem', 'meta', 'nav', 'noembed', 'noframes', 'noscript', 'object', 'ol', 'p', 'param', 'plaintext', 'pre', 'runlogic', 'section', 'select', 'source', 'style', 'summary', 'table', 'tbody', 'td', 'template', 'textarea', 'tfoot', 'th', 'thead', 'title', 'tr', 'track', 'ul', 'wbr', 'xmp'];
        ...
        var isTagValidWithParent = function (tag, parentTag) {
            ...
            switch (parentTag) {
                ...
                case 'tr':
                    return tag === 'th' || tag === 'td' || tag === 'style' || tag === 'runlogic' || tag === 'template';
                // https://html.spec.whatwg.org/multipage/syntax.html#parsing-main-intbody
                case 'tbody':
                case 'thead':
                case 'tfoot':
                    return tag === 'tr' || tag === 'style' || tag === 'runlogic' || tag === 'template';
                // https://html.spec.whatwg.org/multipage/syntax.html#parsing-main-incolgroup
                case 'colgroup':
                    return tag === 'col' || tag === 'template';
                // https://html.spec.whatwg.org/multipage/syntax.html#parsing-main-intable
                case 'table':
                    return tag === 'caption' || tag === 'colgroup' || tag === 'tbody' || tag === 'tfoot' || tag === 'thead' || tag === 'style' || tag === 'runlogic' || tag === 'template';
                // https://html.spec.whatwg.org/multipage/syntax.html#parsing-main-inhead
                case 'head':
                    return tag === 'base' || tag === 'basefont' || tag === 'bgsound' || tag === 'link' || tag === 'meta' || tag === 'title' || tag === 'noscript' || tag === 'noframes' || tag === 'style' || tag === 'runlogic' || tag === 'template';
    ...
    function logCapturedError(capturedError) {
        ...
        var error = capturedError.error;
        {
            ...
            if (error != null && error._suppressLogging) {
                ...
                console.error(error);
                // For a more detailed description of this blog, see:
