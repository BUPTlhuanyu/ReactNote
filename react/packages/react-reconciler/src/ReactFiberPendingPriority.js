...
function findNextExpirationTimeToWorkOn(completedExpirationTime, root) {
  ...
  //  区间为[latestPendingTime，earliestPendingTime]，latestPendingTime值小于等于earliestPendingTime，
    ...
    // 由于earliestPendingTime始终大于latestPingedTime，因此当earliestPendingTime===0的时候，latestPingedTime始终等于0，这时nextExpirationTimeToWorkOn===0
    // 否则nextExpirationTimeToWorkOn===earliestPendingTime！==0，那么不会进入紧接着的if语句块
