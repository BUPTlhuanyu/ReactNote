...
###### <i>react事件系统是一个非常值得深入分析的部分</i>

###### <i>看这一块的时候正处于毕业答辩期间，这里没有对应源码分析</i>

###### <i>推荐一篇值得参考的文章，文章思路很清晰，目的性很强</i>

- [动画浅析React事件系统和源码](https://juejin.im/post/5bdf0741e51d456b8e1d60be#heading-6)
</details>
