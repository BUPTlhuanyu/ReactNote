...
describe('ReactEmptyComponent', () => {
  ...
  it('should distinguish between a runlogic placeholder and an actual runlogic tag', () => {
    const instance1 = (
      <TogglingComponent firstComponent={null} secondComponent={'runlogic'} />
    );
    const instance2 = (
      <TogglingComponent firstComponent={'runlogic'} secondComponent={null} />
    );
